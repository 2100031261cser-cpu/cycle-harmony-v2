                    ...
                    <Card className="shadow-xl border-t-4 border-pink-400">
                        ...
                        <CardContent className="space-y-6 pt-4">
                            <Button
                                ...
                                className="w-full h-14 text-lg bg-white border-2 border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-pink-200 gap-3 shadow-sm"
                                disabled={loading}
                            >
                    ...
                    <Card className="shadow-xl border-t-4 border-pink-400">
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="p-4 border-2 border-pink-100 rounded-xl bg-pink-50/50 flex items-center justify-between">
